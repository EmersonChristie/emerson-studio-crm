...
const Schema: z.ZodType<Prisma.InquiryUncheckedUpdateManyWithoutArtworkNestedInput> = z
  .object({
    create: z
      .union([
...
export const InquiryUncheckedUpdateManyWithoutArtworkNestedInputObjectSchema = Schema;
