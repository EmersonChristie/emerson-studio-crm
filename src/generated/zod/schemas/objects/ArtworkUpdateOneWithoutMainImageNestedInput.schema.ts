...
const Schema: z.ZodType<Prisma.ArtworkUpdateOneWithoutMainImageNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkUpdateOneWithoutMainImageNestedInputObjectSchema = Schema;
