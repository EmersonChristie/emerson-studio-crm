...
const Schema: z.ZodType<Prisma.SaleUncheckedCreateNestedManyWithoutContactInput> = z
  .object({
    create: z
      .union([
...
export const SaleUncheckedCreateNestedManyWithoutContactInputObjectSchema = Schema;
