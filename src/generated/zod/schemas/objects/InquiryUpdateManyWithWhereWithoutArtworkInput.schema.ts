...
const Schema: z.ZodType<Prisma.InquiryUpdateManyWithWhereWithoutArtworkInput> = z
  .object({
...
export const InquiryUpdateManyWithWhereWithoutArtworkInputObjectSchema = Schema;
