...
const Schema: z.ZodType<Prisma.ContactUpdateManyWithoutEmailCampaignsNestedInput> = z
  .object({
    create: z
      .union([
...
export const ContactUpdateManyWithoutEmailCampaignsNestedInputObjectSchema = Schema;
