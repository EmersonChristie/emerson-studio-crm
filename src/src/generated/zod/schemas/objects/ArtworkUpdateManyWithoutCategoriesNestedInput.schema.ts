...
const Schema: z.ZodType<Prisma.ArtworkUpdateManyWithoutCategoriesNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkUpdateManyWithoutCategoriesNestedInputObjectSchema = Schema;
