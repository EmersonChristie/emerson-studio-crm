...
const Schema: z.ZodType<Prisma.ArtworkListUncheckedCreateNestedManyWithoutArtworksInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkListUncheckedCreateNestedManyWithoutArtworksInputObjectSchema = Schema;
