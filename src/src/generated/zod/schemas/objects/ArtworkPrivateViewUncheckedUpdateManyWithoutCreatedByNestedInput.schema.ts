...
const Schema: z.ZodType<Prisma.ArtworkPrivateViewUncheckedUpdateManyWithoutCreatedByNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkPrivateViewUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema = Schema;
