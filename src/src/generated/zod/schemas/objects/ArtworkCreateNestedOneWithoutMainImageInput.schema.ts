...
const Schema: z.ZodType<Prisma.ArtworkCreateNestedOneWithoutMainImageInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkCreateNestedOneWithoutMainImageInputObjectSchema = Schema;
