...
const Schema: z.ZodType<Prisma.EmailCampaignUncheckedCreateNestedManyWithoutContactsInput> = z
  .object({
    create: z
      .union([
...
export const EmailCampaignUncheckedCreateNestedManyWithoutContactsInputObjectSchema = Schema;
