...
const Schema: z.ZodType<Prisma.ArtworkOfferUncheckedCreateNestedManyWithoutContactInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkOfferUncheckedCreateNestedManyWithoutContactInputObjectSchema = Schema;
