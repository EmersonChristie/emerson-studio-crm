...
const Schema: z.ZodType<Prisma.InvoiceUncheckedCreateWithoutCreatedByInput> = z
  .object({
...
export const InvoiceUncheckedCreateWithoutCreatedByInputObjectSchema = Schema;
