...
const Schema: z.ZodType<Prisma.ArtworkCategoryCreateNestedOneWithoutMainImageInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkCategoryCreateNestedOneWithoutMainImageInputObjectSchema = Schema;
