...
const Schema: z.ZodType<Prisma.ArtworkUpdateManyWithWhereWithoutPrivateViewsInput> = z
  .object({
...
export const ArtworkUpdateManyWithWhereWithoutPrivateViewsInputObjectSchema = Schema;
