...
const Schema: z.ZodType<Prisma.InquiryUncheckedUpdateManyWithoutInquiriesInput> = z
  .object({
...
export const InquiryUncheckedUpdateManyWithoutInquiriesInputObjectSchema = Schema;
