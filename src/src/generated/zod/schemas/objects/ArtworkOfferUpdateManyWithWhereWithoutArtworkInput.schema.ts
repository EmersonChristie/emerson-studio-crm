...
const Schema: z.ZodType<Prisma.ArtworkOfferUpdateManyWithWhereWithoutArtworkInput> = z
  .object({
...
export const ArtworkOfferUpdateManyWithWhereWithoutArtworkInputObjectSchema = Schema;
