...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutPrivateViewsInput> = z
  .object({
...
export const UserUncheckedCreateWithoutPrivateViewsInputObjectSchema = Schema;
