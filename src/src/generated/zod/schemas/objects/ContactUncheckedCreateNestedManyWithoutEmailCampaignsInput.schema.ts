...
const Schema: z.ZodType<Prisma.ContactUncheckedCreateNestedManyWithoutEmailCampaignsInput> = z
  .object({
    create: z
      .union([
...
export const ContactUncheckedCreateNestedManyWithoutEmailCampaignsInputObjectSchema = Schema;
