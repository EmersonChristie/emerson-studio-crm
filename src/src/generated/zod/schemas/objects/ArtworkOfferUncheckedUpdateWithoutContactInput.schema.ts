...
const Schema: z.ZodType<Prisma.ArtworkOfferUncheckedUpdateWithoutContactInput> = z
  .object({
...
export const ArtworkOfferUncheckedUpdateWithoutContactInputObjectSchema = Schema;
