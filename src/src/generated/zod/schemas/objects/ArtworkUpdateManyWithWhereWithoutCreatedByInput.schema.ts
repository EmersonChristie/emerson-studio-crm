...
const Schema: z.ZodType<Prisma.ArtworkUpdateManyWithWhereWithoutCreatedByInput> = z
  .object({
...
export const ArtworkUpdateManyWithWhereWithoutCreatedByInputObjectSchema = Schema;
