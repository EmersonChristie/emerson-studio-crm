...
const Schema: z.ZodType<Prisma.ArtworkPrivateViewCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkPrivateViewCreateNestedManyWithoutCreatedByInputObjectSchema = Schema;
