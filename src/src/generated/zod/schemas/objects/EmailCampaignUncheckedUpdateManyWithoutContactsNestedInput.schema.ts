...
const Schema: z.ZodType<Prisma.EmailCampaignUncheckedUpdateManyWithoutContactsNestedInput> = z
  .object({
    create: z
      .union([
...
export const EmailCampaignUncheckedUpdateManyWithoutContactsNestedInputObjectSchema = Schema;
