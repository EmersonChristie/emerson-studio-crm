...
const Schema: z.ZodType<Prisma.ContactAddressUncheckedUpdateOneWithoutContactNestedInput> = z
  .object({
    create: z
      .union([
...
export const ContactAddressUncheckedUpdateOneWithoutContactNestedInputObjectSchema = Schema;
