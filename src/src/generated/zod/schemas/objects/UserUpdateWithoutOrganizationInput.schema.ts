...
import { EmailCampaignUpdateManyWithoutCreatedByNestedInputObjectSchema } from './EmailCampaignUpdateManyWithoutCreatedByNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutOrganizationInput> = z
  .object({
    ...
    emailCampaigns: z.lazy(() => EmailCampaignUpdateManyWithoutCreatedByNestedInputObjectSchema).optional(),
...
export const UserUpdateWithoutOrganizationInputObjectSchema = Schema;
