...
const Schema: z.ZodType<Prisma.ImageUncheckedUpdateWithoutArtworkCategoryMainInput> = z
  .object({
...
export const ImageUncheckedUpdateWithoutArtworkCategoryMainInputObjectSchema = Schema;
