...
const Schema: z.ZodType<Prisma.InquiryUncheckedUpdateManyWithoutArtworksNestedInput> = z
  .object({
    create: z
      .union([
...
export const InquiryUncheckedUpdateManyWithoutArtworksNestedInputObjectSchema = Schema;
