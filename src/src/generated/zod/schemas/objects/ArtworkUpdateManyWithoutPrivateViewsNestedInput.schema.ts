...
const Schema: z.ZodType<Prisma.ArtworkUpdateManyWithoutPrivateViewsNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkUpdateManyWithoutPrivateViewsNestedInputObjectSchema = Schema;
