...
const Schema: z.ZodType<Prisma.ArtworkOfferUncheckedUpdateManyWithoutOffersInput> = z
  .object({
...
export const ArtworkOfferUncheckedUpdateManyWithoutOffersInputObjectSchema = Schema;
