...
const Schema: z.ZodType<Prisma.ArtworkOfferUncheckedCreateNestedManyWithoutArtworkInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkOfferUncheckedCreateNestedManyWithoutArtworkInputObjectSchema = Schema;
