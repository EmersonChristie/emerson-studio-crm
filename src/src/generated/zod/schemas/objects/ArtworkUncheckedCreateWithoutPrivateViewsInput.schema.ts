...
const Schema: z.ZodType<Prisma.ArtworkUncheckedCreateWithoutPrivateViewsInput> = z
  .object({
...
export const ArtworkUncheckedCreateWithoutPrivateViewsInputObjectSchema = Schema;
