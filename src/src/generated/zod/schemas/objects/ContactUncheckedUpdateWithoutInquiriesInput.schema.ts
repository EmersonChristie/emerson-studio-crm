...
const Schema: z.ZodType<Prisma.ContactUncheckedUpdateWithoutInquiriesInput> = z
  .object({
...
export const ContactUncheckedUpdateWithoutInquiriesInputObjectSchema = Schema;
