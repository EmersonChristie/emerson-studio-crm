...
const Schema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutCreatedByNestedInput> = z
  .object({
    create: z
      .union([
...
export const InvoiceUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema = Schema;
