...
const Schema: z.ZodType<Prisma.ArtworkUncheckedUpdateWithoutInquiriesInput> = z
  .object({
...
export const ArtworkUncheckedUpdateWithoutInquiriesInputObjectSchema = Schema;
