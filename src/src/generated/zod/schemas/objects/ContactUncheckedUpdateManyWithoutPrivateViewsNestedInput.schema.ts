...
const Schema: z.ZodType<Prisma.ContactUncheckedUpdateManyWithoutPrivateViewsNestedInput> = z
  .object({
    create: z
      .union([
...
export const ContactUncheckedUpdateManyWithoutPrivateViewsNestedInputObjectSchema = Schema;
