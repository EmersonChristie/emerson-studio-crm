...
const Schema: z.ZodType<Prisma.ArtworkPrivateViewUncheckedUpdateManyWithoutContactsNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkPrivateViewUncheckedUpdateManyWithoutContactsNestedInputObjectSchema = Schema;
