...
const Schema: z.ZodType<Prisma.ArtworkUpdateManyWithoutInquiriesNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkUpdateManyWithoutInquiriesNestedInputObjectSchema = Schema;
