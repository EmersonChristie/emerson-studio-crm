...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutPrivateViewsInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutPrivateViewsInputObjectSchema = Schema;
