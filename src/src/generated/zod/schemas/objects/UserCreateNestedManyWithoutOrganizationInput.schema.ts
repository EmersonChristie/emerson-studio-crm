...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutOrganizationInput> = z
  .object({
    create: z
      .union([
...
export const UserCreateNestedManyWithoutOrganizationInputObjectSchema = Schema;
