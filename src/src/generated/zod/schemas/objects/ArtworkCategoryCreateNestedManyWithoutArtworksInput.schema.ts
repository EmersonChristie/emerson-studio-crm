...
const Schema: z.ZodType<Prisma.ArtworkCategoryCreateNestedManyWithoutArtworksInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkCategoryCreateNestedManyWithoutArtworksInputObjectSchema = Schema;
