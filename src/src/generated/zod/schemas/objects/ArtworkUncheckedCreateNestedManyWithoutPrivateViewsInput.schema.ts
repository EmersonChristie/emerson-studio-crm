...
const Schema: z.ZodType<Prisma.ArtworkUncheckedCreateNestedManyWithoutPrivateViewsInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkUncheckedCreateNestedManyWithoutPrivateViewsInputObjectSchema = Schema;
