...
const Schema: z.ZodType<Prisma.InquiryCreateNestedManyWithoutArtworksInput> = z
  .object({
    create: z
      .union([
...
export const InquiryCreateNestedManyWithoutArtworksInputObjectSchema = Schema;
