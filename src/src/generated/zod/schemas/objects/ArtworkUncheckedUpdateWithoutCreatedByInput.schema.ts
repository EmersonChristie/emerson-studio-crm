...
const Schema: z.ZodType<Prisma.ArtworkUncheckedUpdateWithoutCreatedByInput> = z
  .object({
...
export const ArtworkUncheckedUpdateWithoutCreatedByInputObjectSchema = Schema;
