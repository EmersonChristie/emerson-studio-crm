...
const Schema: z.ZodType<Prisma.ArtworkListUncheckedUpdateManyWithoutArtworksNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkListUncheckedUpdateManyWithoutArtworksNestedInputObjectSchema = Schema;
