...
const Schema: z.ZodType<Prisma.ImageUncheckedUpdateWithoutArtworkMainInput> = z
  .object({
...
export const ImageUncheckedUpdateWithoutArtworkMainInputObjectSchema = Schema;
