...
const Schema: z.ZodType<Prisma.InvoiceCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const InvoiceCreateNestedManyWithoutCreatedByInputObjectSchema = Schema;
