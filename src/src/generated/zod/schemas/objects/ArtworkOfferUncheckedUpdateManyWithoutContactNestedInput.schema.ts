...
const Schema: z.ZodType<Prisma.ArtworkOfferUncheckedUpdateManyWithoutContactNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkOfferUncheckedUpdateManyWithoutContactNestedInputObjectSchema = Schema;
