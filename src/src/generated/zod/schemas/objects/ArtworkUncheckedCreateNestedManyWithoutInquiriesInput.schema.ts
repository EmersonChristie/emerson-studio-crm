...
const Schema: z.ZodType<Prisma.ArtworkUncheckedCreateNestedManyWithoutInquiriesInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkUncheckedCreateNestedManyWithoutInquiriesInputObjectSchema = Schema;
