...
const Schema: z.ZodType<Prisma.ContactUpdateManyWithWhereWithoutEmailCampaignsInput> = z
  .object({
...
export const ContactUpdateManyWithWhereWithoutEmailCampaignsInputObjectSchema = Schema;
