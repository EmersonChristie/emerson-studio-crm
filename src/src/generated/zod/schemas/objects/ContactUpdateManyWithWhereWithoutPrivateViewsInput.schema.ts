...
const Schema: z.ZodType<Prisma.ContactUpdateManyWithWhereWithoutPrivateViewsInput> = z
  .object({
...
export const ContactUpdateManyWithWhereWithoutPrivateViewsInputObjectSchema = Schema;
