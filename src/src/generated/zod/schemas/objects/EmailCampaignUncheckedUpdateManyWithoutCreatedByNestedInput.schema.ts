...
const Schema: z.ZodType<Prisma.EmailCampaignUncheckedUpdateManyWithoutCreatedByNestedInput> = z
  .object({
    create: z
      .union([
...
export const EmailCampaignUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema = Schema;
