...
const Schema: z.ZodType<Prisma.ArtworkCategoryUpdateManyWithoutArtworksNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkCategoryUpdateManyWithoutArtworksNestedInputObjectSchema = Schema;
