...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutOrganizationInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutOrganizationInputObjectSchema = Schema;
