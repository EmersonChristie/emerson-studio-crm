...
const Schema: z.ZodType<Prisma.ArtworkUncheckedCreateWithoutCategoriesInput> = z
  .object({
...
export const ArtworkUncheckedCreateWithoutCategoriesInputObjectSchema = Schema;
