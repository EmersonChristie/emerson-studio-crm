...
const Schema: z.ZodType<Prisma.InquiryUncheckedUpdateManyWithoutContactNestedInput> = z
  .object({
    create: z
      .union([
...
export const InquiryUncheckedUpdateManyWithoutContactNestedInputObjectSchema = Schema;
