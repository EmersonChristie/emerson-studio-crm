...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutEmailCampaignsInput> = z
  .object({
...
export const UserUncheckedCreateWithoutEmailCampaignsInputObjectSchema = Schema;
