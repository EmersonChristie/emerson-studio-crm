...
const Schema: z.ZodType<Prisma.ArtworkCategoryUpdateOneWithoutMainImageNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkCategoryUpdateOneWithoutMainImageNestedInputObjectSchema = Schema;
