...
const Schema: z.ZodType<Prisma.ArtworkUncheckedCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema = Schema;
