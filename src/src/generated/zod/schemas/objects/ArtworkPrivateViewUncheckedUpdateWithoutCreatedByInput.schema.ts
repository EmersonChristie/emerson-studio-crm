...
const Schema: z.ZodType<Prisma.ArtworkPrivateViewUncheckedUpdateWithoutCreatedByInput> = z
  .object({
...
export const ArtworkPrivateViewUncheckedUpdateWithoutCreatedByInputObjectSchema = Schema;
