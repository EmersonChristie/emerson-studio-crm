...
const Schema: z.ZodType<Prisma.ContactUncheckedCreateWithoutEmailCampaignsInput> = z
  .object({
...
export const ContactUncheckedCreateWithoutEmailCampaignsInputObjectSchema = Schema;
