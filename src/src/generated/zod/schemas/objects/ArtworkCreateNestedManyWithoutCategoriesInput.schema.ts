...
const Schema: z.ZodType<Prisma.ArtworkCreateNestedManyWithoutCategoriesInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkCreateNestedManyWithoutCategoriesInputObjectSchema = Schema;
