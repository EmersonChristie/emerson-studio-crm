...
const Schema: z.ZodType<Prisma.ContactUncheckedUpdateWithoutPrivateViewsInput> = z
  .object({
...
export const ContactUncheckedUpdateWithoutPrivateViewsInputObjectSchema = Schema;
