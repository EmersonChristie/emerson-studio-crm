...
import { ArtworkPrivateViewUncheckedUpdateManyWithoutArtworksNestedInputObjectSchema } from './ArtworkPrivateViewUncheckedUpdateManyWithoutArtworksNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ArtworkUncheckedUpdateWithoutCategoriesInput> = z
  .object({
    ...
    privateViews: z.lazy(() => ArtworkPrivateViewUncheckedUpdateManyWithoutArtworksNestedInputObjectSchema).optional(),
    offers: z.lazy(() => ArtworkOfferUncheckedUpdateManyWithoutArtworkNestedInputObjectSchema).optional(),
  })
  .strict();

export const ArtworkUncheckedUpdateWithoutCategoriesInputObjectSchema = Schema;
