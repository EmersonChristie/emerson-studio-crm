...
const Schema: z.ZodType<Prisma.ContactAddressUncheckedCreateNestedOneWithoutContactInput> = z
  .object({
    create: z
      .union([
...
export const ContactAddressUncheckedCreateNestedOneWithoutContactInputObjectSchema = Schema;
