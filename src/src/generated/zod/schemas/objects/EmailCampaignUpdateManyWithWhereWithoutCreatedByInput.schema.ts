...
const Schema: z.ZodType<Prisma.EmailCampaignUpdateManyWithWhereWithoutCreatedByInput> = z
  .object({
...
export const EmailCampaignUpdateManyWithWhereWithoutCreatedByInputObjectSchema = Schema;
