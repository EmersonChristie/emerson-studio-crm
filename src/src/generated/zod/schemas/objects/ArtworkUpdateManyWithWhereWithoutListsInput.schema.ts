...
const Schema: z.ZodType<Prisma.ArtworkUpdateManyWithWhereWithoutListsInput> = z
  .object({
...
export const ArtworkUpdateManyWithWhereWithoutListsInputObjectSchema = Schema;
