...
const Schema: z.ZodType<Prisma.SaleUncheckedUpdateManyWithoutArtworkNestedInput> = z
  .object({
    create: z
      .union([
...
export const SaleUncheckedUpdateManyWithoutArtworkNestedInputObjectSchema = Schema;
