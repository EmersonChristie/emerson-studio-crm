...
import { ArtworkCategoryOrderByWithRelationInputObjectSchema } from './ArtworkCategoryOrderByWithRelationInput.schema';
...
const Schema: z.ZodType<Prisma.ImageOrderByWithRelationInput> = z
  .object({
    ...
    artworkCategoryMain: z.lazy(() => ArtworkCategoryOrderByWithRelationInputObjectSchema).optional(),
  })
  .strict();
