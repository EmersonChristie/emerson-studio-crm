...
const Schema: z.ZodType<Prisma.InquiryUpdateManyWithWhereWithoutArtworksInput> = z
  .object({
...
export const InquiryUpdateManyWithWhereWithoutArtworksInputObjectSchema = Schema;
