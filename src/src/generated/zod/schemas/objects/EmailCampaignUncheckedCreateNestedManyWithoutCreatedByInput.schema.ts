...
const Schema: z.ZodType<Prisma.EmailCampaignUncheckedCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const EmailCampaignUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema = Schema;
