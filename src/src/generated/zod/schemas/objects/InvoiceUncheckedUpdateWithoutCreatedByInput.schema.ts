...
const Schema: z.ZodType<Prisma.InvoiceUncheckedUpdateWithoutCreatedByInput> = z
  .object({
...
export const InvoiceUncheckedUpdateWithoutCreatedByInputObjectSchema = Schema;
