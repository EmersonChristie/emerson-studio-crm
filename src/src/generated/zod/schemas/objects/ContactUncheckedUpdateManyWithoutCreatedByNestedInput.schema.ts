...
const Schema: z.ZodType<Prisma.ContactUncheckedUpdateManyWithoutCreatedByNestedInput> = z
  .object({
    create: z
      .union([
...
export const ContactUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema = Schema;
