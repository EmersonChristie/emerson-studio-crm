...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutOrganizationNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUncheckedUpdateManyWithoutOrganizationNestedInputObjectSchema = Schema;
