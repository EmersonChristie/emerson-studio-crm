...
const Schema: z.ZodType<Prisma.ArtworkOfferUncheckedUpdateWithoutArtworkInput> = z
  .object({
...
export const ArtworkOfferUncheckedUpdateWithoutArtworkInputObjectSchema = Schema;
