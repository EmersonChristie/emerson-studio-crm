...
const Schema: z.ZodType<Prisma.ContactUncheckedCreateNestedManyWithoutCreatedByInput> = z
  .object({
    create: z
      .union([
...
export const ContactUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema = Schema;
