...
const Schema: z.ZodType<Prisma.ArtworkOfferUncheckedUpdateManyWithoutArtworkNestedInput> = z
  .object({
    create: z
      .union([
...
export const ArtworkOfferUncheckedUpdateManyWithoutArtworkNestedInputObjectSchema = Schema;
